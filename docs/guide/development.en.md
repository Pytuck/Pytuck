...
> [!NOTE]
> `pyproject.toml` now uses `license = "MIT"` in SPDX string format, and the setuptools deprecation warning has been eliminated. The minimum supported version is now Python 3.10+.
